...
import 'package:openapi/src/api/auth_controller_api.dart';
import 'package:openapi/src/api/profile_controller_api.dart';

class Openapi {
  static const String basePath = r'http://127.0.0.1:3020/api/auth-service';
